...
public class VectorTorTrapPanelManager : MonoBehaviour {

    public MainSysPanel BckMainPanel;
    public VectorTorTrapPanelManager VectorTorTrapSelfPanel;
    ...
    void ReturnMainBtnClick()
    {
        ...
        VectorTorTrapSelfPanel.gameObject.SetActive(false);
    ...
    void StartMotionBtnClick()
    {
        ...
        DynaLinkHS.CmdSyncVectorTorqueTrapezoidalAst(UI_XPosVal, UI_YPosVal, UI_MaxTorVal);
